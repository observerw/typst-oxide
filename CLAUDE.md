...
- Parser accuracy for edge cases
- Database query correctness
- LSP message handling

### Integration Tests

- End-to-end LSP workflow testing
...
2. Configure workspace root directory
3. Set up file watchers

### Testing

- Use VS Code extension for manual testing
- Automated test suite with sample PKM files
